    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={() => speciality === 'Cardiologist' ? navigate('/doctors') : navigate('/doctors/Cardiologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Cardiologist" ? "bg-blue-100 text-black" : ""}`}>Cardiologist</p>
          <p onClick={() => speciality === 'Oncologist' ? navigate('/doctors') : navigate('/doctors/Oncologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Oncologist" ? "bg-blue-100 text-black" : ""}`}>Oncologist</p>
          <p onClick={() => speciality === 'Otolaryngologist' ? navigate('/doctors') : navigate('/doctors/Otolaryngologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Otolaryngologist" ? "bg-blue-100 text-black" : ""}`}>Otolaryngologist</p>
          <p onClick={() => speciality === 'Radiologist' ? navigate('/doctors') : navigate('/doctors/Radiologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Radiologist" ? "bg-blue-100 text-black" : ""}`}>Radiologist</p>
        </div>
